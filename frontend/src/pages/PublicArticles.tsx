...
import { Palette, LogIn, Github } from 'lucide-react';
    ...
    <div className={`flex flex-col min-h-screen bg-gray-100 theme-${theme}`}>
      ...
      <footer className="bg-gray-800 text-white text-center py-4 mt-auto">
        ...
        <div className="flex justify-center space-x-4 mt-2">
          <a href="https://www.instagram.com/deepanshu_jindal/" target="_blank" rel="noopener noreferrer" className="hover:text-pink-500">
            <Instagram className="w-6 h-6" />
          </a>
          <a href="https://www.linkedin.com/in/deepanshu-jindal-664303238/" target="_blank" rel="noopener noreferrer" className="hover:text-blue-500">
            <Linkedin className="w-6 h-6" />
          </a>
          <a href="https://github.com/Deepanshu907" target="_blank" rel="noopener noreferrer" className="hover:text-blue-700">
